...
{
    public partial class BlowingRainInsideTestDataSheetEditor : DevExpress.XtraEditors.XtraForm, ILabForm, ILabWindow
    {
        public TestForm LabTestForm { get; set; } = null;
        public BlowingRainInsideTestDataSheet el { get; set; } = null;
        public bool isTablet { get; set; } = false;
        public BlowingRainInsideTestDataSheetEditor()
        {
            InitializeComponent();
        }

        public BlowingRainInsideTestDataSheetEditor(TestForm f, bool isTab = false) : this()
        {
            this.LabTestForm = f;
            this.isTablet = isTab;
        }
        ...
        public void load()
        {
            this.el = BlowingRainInsideTestDataSheet.Load(this.LabTestForm);
            ...
            if (this.isTablet)
            {
                ...
                {
                    // txtInchesPerHour, txtPressure, txtVelocityMph, txtVelocityFtMin, txtDistance, txtDetail0, txtDetail1, txtDetail2, txtDetail3, txtDetail4, txtDetail5, txtDetail6, txtDetail7, txtJobNo, txtDate, txtNote, txtEngineer, txtJobNo1, txtDate1, txtEngineer1, 
                };
                ...
                {
                    // lblInchesPerHour, lblPressure, lblVelocityMph, lblVelocityFtMin, lblDistance, lblDetail0, lblDetail1, lblDetail2, lblDetail3, lblDetail4, lblDetail5, lblDetail6, lblDetail7, lblJobNo, lblDate, lblNote, lblEngineer, lblJobNo1, lblDate1, lblEngineer1, 
                };
        ...
        public void Save()
        {
            ...
            this.LabTestForm.Content = BlowingRainInsideTestDataSheet.Save(this.el);
        ...
        //{
        //    return new BlowingRainInsideTestDataSheetReport(this.el);
        //}

        private void add(GridControl grdControl, GridView grdView)
        {
            this.el.Data.Add(new BlowingRainInsideTestDataSheet.TestData());
