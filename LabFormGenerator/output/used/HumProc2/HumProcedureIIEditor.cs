...
{
    public partial class HumProcedureIIEditor : DevExpress.XtraEditors.XtraForm, ILabForm, ILabWindow
    {
        public TestForm LabTestForm { get; set; } = null;
        public HumProcedureII el { get; set; } = null;
        public bool isTablet { get; set; } = false;
        public HumProcedureIIEditor()
        {
            InitializeComponent();
        }

        public HumProcedureIIEditor(TestForm f, bool isTab = false) : this()
        {
            this.LabTestForm = f;
            this.isTablet = isTab;
        }
        ...
        public void load()
        {
            this.el = HumProcedureII.Load(this.LabTestForm);
        ...
        public void Save()
        {
            ...
            this.LabTestForm.Content = HumProcedureII.Save(this.el);
        ...
        {
            return new HumProcedureIIReport(this.el);
        }

        private void add(GridControl grdControl, GridView grdView)
        {
            // this.el.Data.Add(new HumProcedureII.TestData());
        ...
        private void HumProcedureIIEditor_Load(object sender, EventArgs e)
        {
            try
            {
                load();
