...
{
    partial class RainProcI810GDataSheetReport
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.xrLabel02.Text = "From Paragraph 2.3.2 of MILSTD810G Change Notice 1 & MILSTD810H: During the pretest setup rain fall\nmeasurements should be taken at a minimum of 5 random locations. The average of these rain rate measurements\nshould be within 10% or +/ mm/min (0.25 in/hr) of the specified value whichever is less. To ensure a uniform\n distribution of simulated rain on the test item each measurement should be within 25% or +/ 0.2 mm/min (0.5 in/hr)\nof the specified rain rate whichever is less";
            ...
            this.xrLabel03.Text = "Enter Required\nRainfall Rate\n(Inch/Hour):";
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[ReqRainRate]")});
            ...
            this.xrLabel04.Text = "Distance From\nNozzle In Inches:";
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[DistFromNozzle]")});
            ...
            this.xrLabel05.Text = "NOTE: The rainfall rate at each measured location should be within\n 25% or 0.5 in/hr (whichever is less) of the required rain rate.";
            ...
            this.xrLabel06.Text = "Average Rainfall Rate of 5 Measured Locations:\n(Calculated from measurements entered above\nif entered into the spreadsheet)";
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[AvgRainRate5Loc]")});
            ...
            this.xrLabel07.Text = "NOTE: Average rain rate of the locations measured should be within\n10% or 0.25 in/hr (whichever is less) of the required rainfall rate.";
            ...
            this.ReportHeader.HeightF = 976.7499F;
            ...
            this.xrLabel32.Text = "RAIN PROCEDURE I, 810G DATA SHEET";
            ...
            // objectDataSource1
            // 
            this.objectDataSource1.DataSource = typeof(DTB.Lab.Forms.Models.RainProcI810GDataSheet);
            this.objectDataSource1.Name = "objectDataSource1";
            // 
            // RainProcI810GDataSheetReport
            // 
