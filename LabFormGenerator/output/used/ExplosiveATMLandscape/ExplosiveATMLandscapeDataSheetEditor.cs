...
{
    public partial class ExplosiveATMLandscapeDataSheetEditor : DevExpress.XtraEditors.XtraForm, ILabForm, ILabWindow
    {
        public TestForm LabTestForm { get; set; } = null;
        public ExplosiveATMLandscapeDataSheet el { get; set; } = null;
        public bool isTablet { get; set; } = false;
        public ExplosiveATMLandscapeDataSheetEditor()
        {
            InitializeComponent();
        }

        public ExplosiveATMLandscapeDataSheetEditor(TestForm f, bool isTab = false) : this()
        {
            this.LabTestForm = f;
            this.isTablet = isTab;
        }
        ...
        public void load()
        {
            this.el = ExplosiveATMLandscapeDataSheet.Load(this.LabTestForm);
            ...
            if (this.isTablet)
            {
                ...
                {
                    // txtJobNo, txtDate, txtTest, txtRemarks, txtEngineer, 
                };
                ...
                {
                    // lblNote, lblJobNo, lblDate, lblTest, lblRemarks, lblEngineer, lblNote001, lblNote002, lblNote003, 
                };
        ...
        public void Save()
        {
            ...
            this.LabTestForm.Content = ExplosiveATMLandscapeDataSheet.Save(this.el);
        ...
        {
            return new ExplosiveATMLandscapeDataSheetReport(this.el);
        }

        private void add(GridControl grdControl, GridView grdView)
        {
            // this.el.Data.Add(new ExplosiveATMLandscapeDataSheet.TestData());
        ...
        private void ExplosiveATMLandscapeDataSheetEditor_Load(object sender, EventArgs e)
        {
            try
            {
                load();
