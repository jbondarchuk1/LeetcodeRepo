...
{
    public partial class SaltFog2HRPreconditioningDataSheetEditor : DevExpress.XtraEditors.XtraForm, ILabForm, ILabWindow
    {
        public TestForm LabTestForm { get; set; } = null;
        public SaltFog2HRPreconditioningDataSheet el { get; set; } = null;
        public bool isTablet { get; set; } = false;
        public SaltFog2HRPreconditioningDataSheetEditor()
        {
            InitializeComponent();
        }

        public SaltFog2HRPreconditioningDataSheetEditor(TestForm f, bool isTab = false) : this()
        {
            this.LabTestForm = f;
            this.isTablet = isTab;
        }
        ...
        public void load()
        {
            this.el = SaltFog2HRPreconditioningDataSheet.Load(this.LabTestForm);
        ...
        public void Save()
        {
            ...
            this.LabTestForm.Content = SaltFog2HRPreconditioningDataSheet.Save(this.el);
        ...
        {
            return new SaltFog2HRPreconditioningDataSheetReport(this.el);
        }

        private void add(GridControl grdControl, GridView grdView)
        {
            // this.el.Data.Add(new SaltFog2HRPreconditioningDataSheet.TestData());
        ...
        private void SaltFog2HRPreconditioningDataSheetEditor_Load(object sender, EventArgs e)
        {
            try
            {
                load();
