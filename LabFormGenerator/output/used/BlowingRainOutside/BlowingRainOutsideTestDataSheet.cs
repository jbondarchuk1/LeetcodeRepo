...
{
    public class BlowingRainOutsideTestDataSheet : ModelBase, ILabModel
    {
        ...
        public static BlowingRainOutsideTestDataSheet Load(string json)
        {
            if (!json.IsValid()) return new BlowingRainOutsideTestDataSheet();
            return JsonConvert.DeserializeObject<BlowingRainOutsideTestDataSheet>(json);
        }

        public static BlowingRainOutsideTestDataSheet Load(TestForm t)
        {
            ...
            if (!t.Content.IsValid())
            {
                ...
                return new BlowingRainOutsideTestDataSheet(lt);
            }
        ...
        public static string Save(BlowingRainOutsideTestDataSheet obj)
        {
        ...
        public string Save()
        {
            return BlowingRainOutsideTestDataSheet.Save(this);
        }

        public BlowingRainOutsideTestDataSheet() {}

        public BlowingRainOutsideTestDataSheet(LabTest t)
        {
			...
			this.EngineSpeed = t.EngineSpeed;
