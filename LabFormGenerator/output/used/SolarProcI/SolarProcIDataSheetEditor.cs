...
{
    public partial class SolarProcIDataSheetEditor : DevExpress.XtraEditors.XtraForm, ILabForm, ILabWindow
    {
        public TestForm LabTestForm { get; set; } = null;
        public SolarProcIDataSheet el { get; set; } = null;
        public bool isTablet { get; set; } = false;
        public SolarProcIDataSheetEditor()
        {
            InitializeComponent();
        }

        public SolarProcIDataSheetEditor(TestForm f, bool isTab = false) : this()
        {
            this.LabTestForm = f;
            this.isTablet = isTab;
        }
        ...
        public void load()
        {
            this.el = SolarProcIDataSheet.Load(this.LabTestForm);
            ...
            if (this.isTablet)
            {
                ...
                {
                    txtJobNo, txtTest, txtDate, txtCycle, txtTechnician, txtEngineer, 
                };
                ...
                {
                    lblJobNo, lblTest, lblDate, lblCycle, lblof3, lblTechnician, lblEngineer, 
                };
        ...
        public void Save()
        {
            ...
            this.LabTestForm.Content = SolarProcIDataSheet.Save(this.el);
        ...
        {
            return new SolarProcIDataSheetReport(this.el);
        }

        private void add(GridControl grdControl, GridView grdView)
        {
            // this.el.Data.Add(new SolarProcIDataSheet.TestData());
        ...
        private void SolarProcIDataSheetEditor_Load(object sender, EventArgs e)
        {
            try
            {
                load();
